...
This is a Claude Code plugin repository containing the **Code Review Plugin** (v3.1.1) - a modular 9-agent architecture with:
...
├── .claude-plugin/plugin.json       # Plugin metadata (v3.1.1)
