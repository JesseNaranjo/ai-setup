...
2. **Phase 1: Thorough Review** (9 agents in parallel)
   - Launch: bug, performance, security, technical-debt (Opus) + api, architecture, compliance, error-handling, test-coverage (Sonnet)
...
3. **Phase 2: Gaps Review** (5 Sonnet agents in parallel)
   - Launch: bug, compliance, performance, security, technical-debt
   - MODE: `gaps`
...
4. **Synthesis** (4 agents in parallel)
   ...
   - Pairs: Architecture+Test Coverage, Bugs+Error Handling, Security+Performance, Technical Debt+Compliance
...
2. **Review** (4 agents in parallel)
   - Launch: bug, error-handling, security, test-coverage
   - MODE: `quick` for all agents
   - OUTPUT: Quick review findings

3. **Synthesis** (3 agents in parallel)
   - Pairs: Bugs+Error Handling, Bugs+Security, Bugs+Test Coverage
   - OUTPUT: `cross_cutting_insights` list
