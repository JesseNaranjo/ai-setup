...
Domain-specific auto-validation patterns and false positive rules for documentation review commands.
For shared validation process, see `${CLAUDE_PLUGIN_ROOT}/shared/validation-rules.md`.
...
Each category has specific exclusions in addition to the general false positive rules in `validation-rules.md`.
